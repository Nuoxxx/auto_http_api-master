...
class ExcelReport():
    ...
    def init(self, worksheet, data):
        ...
        _write_center(worksheet, "C4", data['test_version'], self.wd)
        _write_center(worksheet, "C5", data['test_pl'], self.wd)
        _write_center(worksheet, "C6", data['test_net'], self.wd)
        ...
        _write_center(worksheet, "E3", data['test_sum'], self.wd)
        _write_center(worksheet, "E4", data['test_success'], self.wd)
        _write_center(worksheet, "E5", data['test_failed'], self.wd)
        _write_center(worksheet, "E6", data['test_date'], self.wd)
